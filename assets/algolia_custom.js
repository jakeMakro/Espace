      ...
      hits({
        ...
        templates: {
          item(hit, { html, components }) {
            let compare_at = "",ptr_tag = "",inventory_tag = "",noImg = "",coll_logos = "",rebate_end_date = "",wishlist_tag = "",des = "",meta_RebateCollection = "",meta_RebateDocument = "",brand_label = "",brand_logos = "";
            let title = hit.title;
            ...
            if(collection_logos.length > 0){
              coll_logos = `<div class="coll-logos">`;
              for(var a=0;a<collection_logos.length;a++){
                coll_logos = coll_logos + `<img src="${collection_logos[a]}">`;
              }
              coll_logos = coll_logos + `</div>`;
            }
