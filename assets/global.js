...
class VariantSelects extends HTMLElement {
 ...
 updateMedia() {
   ...
   $(".carousel-cell img").each(function(){
     var getVariantId = $(this).attr("data-media-id");
     if(getVariantId == current_media_id){
       var GetIndex = $(this).attr("data-index");
       flkty.select( GetIndex-1 );
     }
   });
...
class ProductRecentlyViewed extends HTMLElement {
  ...
  initSlider(){
    ...
    var mySwiper = new Swiper (eleSlide, {
      ...
      speed: 900,
      navigation: {
        nextEl: ".recently-view-nav .slider-next",
        prevEl: ".recently-view-nav .slider-prev",
      },
      breakpoints: {
        1023: {
          slidesPerView: 4,
...
class LoadingBar extends HTMLElement {
  ...
  show() {
    ...
    document.body.classList.add('theme-loading-start');
  }
  hide() {
  ...
  onTransitionEnd(event) {
    if (event.propertyName === "transform" && this.classList.contains("is-finished")) {
      ...
      document.body.classList.remove('theme-loading-start');
    }
  }
}
